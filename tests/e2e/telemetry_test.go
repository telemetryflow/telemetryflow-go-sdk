// Package e2e provides end-to-end tests for the TelemetryFlow SDK. These tests require a running TelemetryFlow backend or OTLP collector. Set the following environment variables to run: - TELEMETRYFLOW_API_KEY_ID - TELEMETRYFLOW_API_KEY_SECRET - TELEMETRYFLOW_ENDPOINT (optional, defaults to api.telemetryflow.io:4317).
//
