...
/**
 * Generate Secure Secrets for {{.ProjectName}}
 *
 * Usage:
...
for (let i = 0; i < args.length; i++) {
  switch (args[i]) {
    ...
    case '-h':
      console.log(`
{{.ProjectName}} - Secure Secret Generator
...
if (envOnly) {
  ...
  // Decorated output
  console.log('\n=============================================');
  console.log('  {{.ProjectName}} - Secret Generator');
  console.log('=============================================\n');
  ...
  console.log('  {{.ProjectName | lower}}:latest\n');
